          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center transform transition-all duration-1000 opacity-100 translate-y-0">
            <div className="mb-12 lg:mb-0">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Wanna launch a new app? Refactor the messy legacy code? Rebuild
                your product to scale like a beast? We gotchu. Our crew? Mid to
                senior devs, a project manager who actually replies to Slack,
                and backup talent that ships like pros — 5★ quality,
                lightning-fast.
              </p>
            </div>
