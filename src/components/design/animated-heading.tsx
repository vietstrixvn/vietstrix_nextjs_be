...
export default function AnimatedHeading({
  ...
  useEffect(() => {
    ...
    // Animate each line with manual staggering
    [...wordsByLine.entries()]
      .sort((a, b) => a[0] - b[0])
      .forEach(([lineIndex, words]) => {
        const lineStartDelay = startDelay + lineIndex * lineDelay;

        words.forEach((word, wordIndex) => {
          const wordDelay = lineStartDelay + wordIndex * staggerPerWord;
          ...
          word.animate(
            ...
            ],
            {
              ...
              delay: wordDelay * 1000, // convert to milliseconds
